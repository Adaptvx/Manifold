...
local function OnLoad()
    ...
    local function UpdateCatalogAvailability()
        local enabled = (GetActiveHouseEditorMode() == Enum.HouseEditorMode.BasicDecor)
        HouseEditorFrame.StoragePanel.TabSystem:SetTabEnabled(HouseEditorFrame.StoragePanel.marketTabID, enabled)
    end
    ...
    f:SetScript("OnEvent", function(self, event, ...)
        ...
        --Track mouse state for house chest interaction
    ...
    do -- Force House Chest visibility
        ...
        Timer:SetAction(function()
            ...
            HouseEditorFrame.StoragePanel.collapsed = Data.isHouseChestCollapsed
            HouseEditorFrame.StoragePanel:UpdateCollapseState(true)
        end)
